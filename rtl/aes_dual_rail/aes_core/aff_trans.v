module aff_trans(
    ...
    //True value
    assign aff_trans_out_t[0]       = aff_trans_in_t[0] ^ aff_trans_in_t[4] ^ aff_trans_in_t[5] ^ aff_trans_in_t[6] ^ aff_trans_in_t[7];
    assign aff_trans_out_t[1]       = aff_trans_in_t[0] ^ aff_trans_in_t[1] ^ aff_trans_in_t[5] ^ aff_trans_in_t[6] ^ aff_trans_in_t[7];
    ...
    assign aff_trans_out_t[5]       = aff_trans_in_t[1] ^ aff_trans_in_t[2] ^ aff_trans_in_t[3] ^ aff_trans_in_t[4] ^ aff_trans_in_t[5];
    assign aff_trans_out_t[6]       = aff_trans_in_t[2] ^ aff_trans_in_t[3] ^ aff_trans_in_t[4] ^ aff_trans_in_t[5] ^ aff_trans_in_t[6];
    assign aff_trans_out_t[7]       = aff_trans_in_t[3] ^ aff_trans_in_t[4] ^ aff_trans_in_t[5] ^ aff_trans_in_t[6] ^ aff_trans_in_t[7];
  
    //False value
    assign aff_trans_out_f[0]       = aff_trans_in_f[0] ^ aff_trans_in_f[4] ^ aff_trans_in_f[5] ^ aff_trans_in_f[6] ^ aff_trans_in_f[7];
    assign aff_trans_out_f[1]       = aff_trans_in_f[0] ^ aff_trans_in_f[1] ^ aff_trans_in_f[5] ^ aff_trans_in_f[6] ^ aff_trans_in_f[7];
    ...
    assign aff_trans_out_f[5]       = aff_trans_in_f[1] ^ aff_trans_in_f[2] ^ aff_trans_in_f[3] ^ aff_trans_in_f[4] ^ aff_trans_in_f[5];
    assign aff_trans_out_f[6]       = aff_trans_in_f[2] ^ aff_trans_in_f[3] ^ aff_trans_in_f[4] ^ aff_trans_in_f[5] ^ aff_trans_in_f[6];
