module mix_columns(
    ...
    generate
        for (i = 0; i < 4; i = i + 1) begin 
            ...
            assign a1_t = data_in_t[(i*32+16)+:8]; assign a1_f = data_in_f[(i*32+16)+:8];
            assign a2_t = data_in_t[(i*32+8) +:8]; assign a2_f = data_in_f[(i*32+8) +:8];
            assign a3_t = data_in_t[i*32     +:8]; assign a3_f = data_in_f[i*32     +:8];
            ...
            wire [7:0] b0_t, b0_f, b1_t, b1_f, b2_t, b2_f, b3_t, b3_f;
            genvar k;
            ...
            assign data_out_t[(i*32+24)+:8] = b0_t; assign data_out_f[(i*32+24)+:8] = b0_f;
            assign data_out_t[(i*32+16)+:8] = b1_t; assign data_out_f[(i*32+16)+:8] = b1_f;
            assign data_out_t[(i*32+8) +:8] = b2_t; assign data_out_f[(i*32+8) +:8] = b2_f;
            assign data_out_t[i*32     +:8] = b3_t; assign data_out_f[i*32     +:8] = b3_f;
        end
    endgenerate
